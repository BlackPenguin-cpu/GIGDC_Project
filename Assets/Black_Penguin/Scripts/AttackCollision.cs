...
public class AttackCollision : MonoBehaviour
{
    ...
    {
        return Physics2D.BoxCastAll(transform.parent.position + (Vector3)collider2D.offset, collider2D.size, 0, parentSpriteRenderer.flipX ? Vector2.left : Vector2.right, collider2D.size.x / 2); ;
    }
    /// <summary>
